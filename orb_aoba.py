...
def output():
    with open('result_d={0}.txt'.format(d), 'w') as f:
        print(" ")
        print("output")
        print("  d =",d)
        print("#d =",d, file=f)
        ...
        for orb in Orb:#multiprocessできそう
            ...
            print("  T =",CT, file=f)
            print("  widths list =",[len(c) for c in CT],len(CT), file=f)
            print("  S =",CS, file=f)
            print("  widths list =",[len(c) for c in CS],len(CS), file=f)
            print("  TS =",CTS, file=f)
            print("  widths list =",[len(c) for c in CTS],len(CTS), file=f)
